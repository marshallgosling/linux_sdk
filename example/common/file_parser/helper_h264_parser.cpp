...
HelperH264FileParser::HelperH264FileParser(const char *filepath)
		: file_path_(filepath), data_buffer_(nullptr), data_offset_(0), only_once_(false)
{
}
...
bool HelperH264FileParser::getEndOfFileTag()
{
	return end_of_file_;
}

void HelperH264FileParser::setOnce(bool once)
{
	only_once_ = once;
}
